...
| 2 | Real CSV + concept profiles + JSON state |
| 3 | Reciprocal matchmaking + explanation + approval |
| 4 | Peer learning + outcome + profile update + re-match |
| 5 | Demo polish + fallback |
...
1. Upload quiz
2. Show concept mapping
3. Generate learner profiles
4. Show complementary strengths/gaps
5. Explain **why the pair was selected**
6. Approve the match
7. Generate the peer session
8. Run the follow-up quiz
9. Show learning gain
10. Show updated state / re-matching
...
**Project Plan:** detailed execution reference  
